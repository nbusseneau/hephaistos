...
local function executeLoadHooks()
  for _, callback in ipairs(Hephaistos.LoadHooks) do
    callback()
  end
end

Hephaistos.RegisterPostHook("Load", executeLoadHooks)
Hephaistos.RegisterPostHook("StartNewGame", executeLoadHooks)
Hephaistos.RegisterFilterHooks()
